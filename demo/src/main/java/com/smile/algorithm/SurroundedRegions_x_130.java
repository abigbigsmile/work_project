...
/**
 *关于环绕小岛的并查集方法
 *结合 https://blog.csdn.net/niushuai666/article/details/6662911
 */

public class SurroundedRegions_x_130 {

    int[] unionSet; // union find set
    boolean[] hasEdgeO; // whether an union has an 'O' which is on the edge of the matrix

    public static void main(String[] args) {
        SurroundedRegions_x_130 solution = new SurroundedRegions_x_130();
        char[][] board = {
                {'X','X','X','X'},
                {'X','O','O','X'},
                {'X','O','X','X'},
